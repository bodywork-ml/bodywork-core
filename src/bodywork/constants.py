...
SSH_PRIVATE_KEY_ENV_VAR = 'BODYWORK_GITHUB_SSH_PRIVATE_KEY'
SSH_SECRET_NAME = 'ssh-github-private-key'
TIMEOUT_GRACE_SECONDS = 90

# External SSH Fingerprints
GITHUB_SSH_FINGERPRINT = '2048 SHA256:nThbg6kXUpJWGl7E1IGOCspRomTxdCARLviKw6E5SY8 github.com (RSA)'
GITLAB_SSH_FINGERPRINT = '2048 SHA256:ROQFvPThGrW4RuWLoL9tq9I9zJ42fK4XywyRtbOz/EQ gitlab.com (RSA)'
BITBUCKET_SSH_FINGERPRINT = '2048 SHA256:zzXQOXSRBEiUtuE8AikJYKwbHaxvSc0ojez9YXaGp1A bitbucket.org (RSA)'
